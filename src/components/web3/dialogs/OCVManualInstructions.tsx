				...
				<div className="space-y-4">
						...
						>
							<AlertDescription>
								<div className="space-y-2">
									...
									<div className="space-y-1 text-xs text-orange-800 dark:text-orange-200/90">
										<p>
					...
					<div className="space-y-4">
						<p className="text-center text-sm text-muted-foreground">
							Send a transaction to yourself with the following text in the memo
							field:
						</p>
						...
						<div className="space-y-3">
							...
							<ol className="list-inside list-decimal space-y-2 text-sm text-muted-foreground">
								...
								<li>
									Use your preferred wallet (or a CLI) to create a transaction
								</li>
						...
						<div className="rounded-lg bg-muted/50 p-3">
							<p className="text-xs text-muted-foreground">
								Note: Make sure to follow the exact format of the memo to ensure
								your vote is properly recorded. The transaction must be sent to
								your own address, and the amount can be 0 MINA.
							</p>
						</div>
					</div>
				</div>
