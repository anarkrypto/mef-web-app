						...
						<div className="space-y-8 py-4">
							...
							{selectedFeedback.image && (
								<div className="space-y-4">
									<div className="flex items-center justify-between">
										...
										<div className="flex gap-2">
											<Button
												...
												size="sm"
												onClick={() =>
													handleDownloadImage(selectedFeedback.image!)
												}
											>
									...
									<div
										className="relative h-[300px] w-full cursor-pointer overflow-hidden rounded-lg border"
										onClick={() => setImageModalOpen(true)}
									>
										<Image
							...
							<div className="space-y-4">
								<div className="flex items-center justify-between">
									...
									<Button
										...
										size="sm"
										onClick={() =>
											handleCopyMetadata(selectedFeedback.metadata)
										}
									>
