      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Help us improve by sharing your thoughts. You can optionally include a screenshot.
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="flex-1">
                {screenshot ? (
                  <div className="flex items-center gap-2">
                    <div 
                      className="flex-1 flex items-center gap-2 px-3 py-2 bg-muted rounded-md cursor-pointer hover:bg-muted/80 transition-colors"
                      onClick={handlePreviewClick}
                    >
                      <Icons.image className="h-4 w-4 text-muted-foreground shrink-0" />
                      <span className="text-sm truncate">Screenshot attached</span>
                    </div>
                    <Button
                      type="button"
                      variant="ghost"
