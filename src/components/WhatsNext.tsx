...
export default function WhatsNext() {
	...
	const actions: Action[] = [
		...
		},
		{
			...
			description:
				'See which funding rounds are currently accepting proposals.',
		...
		},
		{
			...
			description:
				'Evaluate and provide feedback on community proposals to help them move forward.',
		...
		},
		{
			...
			description:
				'Engage in conversations about submitted proposals and share your insights.',
					...
					<Card key={index} className="flex flex-col">
						...
						<CardContent className="mt-auto">
							<Button
								...
								onClick={() =>
									handleActionClick(action.route, action.implemented)
								}
