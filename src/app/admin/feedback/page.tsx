...
import {
	FeedbackList,
	type FeedbackItem,
} from '@/components/admin/feedback/FeedbackList'
			...
			<div className="container mx-auto max-w-6xl p-6">
				<Card className="p-6">
					<div className="flex min-h-[400px] flex-col items-center justify-center text-center">
						<Icons.messageSquare className="mb-4 h-12 w-12 text-muted-foreground" />
		...
		<div className="container mx-auto max-w-6xl p-6">
			<div className="mb-8">
				...
				<p className="mt-2 text-muted-foreground">
					View and manage user feedback submissions. Click on any feedback item
					to see more details.
				</p>
			</div>
