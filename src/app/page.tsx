	...
	const renderPhaseComponent = () => {
		...
		if (selectedRound.phase === null) {
			...
			const phases = [
				{
					name: 'Submission',
					startDate: new Date(selectedRound.submissionPhase.startDate),
				},
				{
					name: 'Consideration',
					startDate: new Date(selectedRound.considerationPhase.startDate),
				},
				{
					name: 'Deliberation',
					startDate: new Date(selectedRound.deliberationPhase.startDate),
				},
				{
					name: 'Voting',
					startDate: new Date(selectedRound.votingPhase.startDate),
				},
			]
			...
			if (nextPhase) {
				...
				const previousPhaseName =
					phaseIndex > 0 ? phases[phaseIndex - 1].name : null
